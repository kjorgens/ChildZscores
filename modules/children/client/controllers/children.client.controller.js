(function () {
  ...
  function ChildrenController($rootScope, $scope, $state, $stateParams, $translate, $window,
    ...
    vm.options = {};
    vm.data = {};
    vm.initChartData = setUpChartData;
    vm.initChartData();
        ...
        chart: {
          ...
          yAxis: {
            ...
            tickFormat: function(d) {
              return d3.format(['60, 65, 70, 75, 80'])(d);
            },
...
// function sinAndCos is the date
      vm.data = sinAndCos();
        ...
        return [
          {
            ...
            key: 'Liahona Kids', //key  - the name of the series.
