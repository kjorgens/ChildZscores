(function () {
  ...
  function translateConfig($translateProvider) {
    ...
    var translationsEN = {
      ...
      PLEASE_ENTER_VALID_MUAC: 'Please enter a vaild MUAC (5.5 - 26.5)',
      ...
      GENERATE_CHRONIC_SUPPLEMENT_REPORT:'Generate Chronic supplement report',
      GENERATE_SUMMARY_REPORT: 'Generate Summary Report',
      GENERATE_MISSED_SCREENING_REPORT: 'Generate Missed Screening Report',
      ...
      MONTH_SELECT_SUMMARY_REPORT:'---Select Month Span---',
    ...
    var translationsES = {
      ...
      PLEASE_ENTER_VALID_MUAC: 'Por favor, indtroduzca un MUAC válido ( 5.5 - 26.5 )',
      ...
      GENERATE_CHRONIC_SUPPLEMENT_REPORT:'Generar informe de chronic suplemento',
      GENERATE_SUMMARY_REPORT: 'Generar informe resumido',
      GENERATE_MISSED_SCREENING_REPORT: 'Generar informe de detección perdida',
      ...
      MONTH_SELECT_SUMMARY_REPORT:'---Seleccionar intervalo de meses---',
    ...
    var translationsFR = {
      ...
      GENERATE_CHRONIC_SUPPLEMENT_REPORT:'Générer un rapport de supplément chronique',
