...
self.addEventListener('install', function (event) {
  ...
  event.waitUntil(caches.open(CACHE_LIST['dynamic-cache']).then(function(cache) {
    ...
    return cache.addAll([
      ...
      '/public/lib/angular-nvd3/angular-nvd3.min.js',
      '/public/lib/nvd3/build/nvd3.min.js',
      '/public/lib/angular-ui-router/release/angular-ui-router.min.js',
      '/public/lib/angular-ui-router-uib-modal/release/angular-ui-router-uib-modal.min.js',
      '/public/lib/angular-ui-utils/ui-utils.min.js',
      '/public/lib/angular-ui-notification/angular-ui-notification.min.js',
      ...
      '/modules/children/client/views/list-mothers.client.view.html',
      ...
      '/modules/children/client/views/sync-children.client.view.html',
      '/modules/children/client/img/brazil.png',
      '/modules/children/client/img/bolivia.png',
      '/modules/children/client/img/cambodia.png',
      '/modules/children/client/img/columbia.png',
      '/modules/children/client/img/ecuador.png',
      '/modules/children/client/img/ghana.png',
      '/modules/children/client/img/guatamala.png',
      '/modules/children/client/img/haiti.png',
      '/modules/children/client/img/honduras.png',
      '/modules/children/client/img/mongolia.png',
      '/modules/children/client/img/nicaragua.png',
      '/modules/children/client/img/paraguay.png',
      '/modules/children/client/img/peru.png',
      '/modules/children/client/img/philippines.png',
      '/modules/children/client/img/salvador.png',
      '/modules/children/client/img/sierraleone.png',
      '/modules/children/client/img/zimbabwe.png',
      '/modules/children/client/img/madagascar.png',
