...
module.exports = function (grunt) {
 ...
 //         {src: ['version.json'], dest: '/' },
          ...
          { src: ['README.md'], dest: '/' },
          { src: ['config/**'], dest: '/' },
          { src: ['modules/chat/client/**'], dest: '/' },
          { src: ['modules/children/client/**'], dest: '/' },
          { src: ['modules/core/client/**'], dest: '/' },
          { src: ['modules/users/client/**'], dest: '/' },
          { src: ['modules/chat/server/**'], dest: '/' },
          { src: ['modules/children/server/**'], dest: '/' },
          { src: ['modules/core/server/**'], dest: '/' },
          { src: ['modules/users/server/**'], dest: '/' },
          { src: ['public/**'], dest: '/' },
          { src: ['build/**'], dest: '/' },
          { src: ['scripts/**'], dest: '/' }
        ]
